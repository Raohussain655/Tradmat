...
<li>
  <div className="inline-flex items-center relative">
    <div className={`text-lg font-semibold text-white`}>
      <div className={`inline-flex items-center ${styles.custom}`}>
        Risk Management
      </div>
    </div>
  </div>
  <ul className={`absolute z-10 border border-gray-200 divide-y divide-gray-100 rounded-md ${styles.customcolor}`}>
    {/* Risk Calculater */}
    <li>
      <Link href="/calculater" className={`block px-8 py-4 text-sm ${styles.custom}`}>
        Risk Calculator
      </Link>
    </li>
    {/* Market */}
    <li>
      <div className={`block px-8 py-4 text-sm ${styles.custom}`}>
        Market
      </div>
      <ul className={`absolute w-12 z-10 border border-gray-200 divide-y divide-gray-100 rounded-md ${styles.customcolor} left-full ml-1`}>
        {/* Market Overview Widget */}
        <li>
          <Link href="/market/market-overview" className={`block px-8 py-4 text-sm ${styles.custom}`}>
            Market Overview Widget
          </Link>
        </li>
        {/* Economic Calendar Widget */}
        <li>
          <Link href="/market/economic-calendar" className={`block px-8 py-4 text-sm ${styles.custom}`}>
            Economic Calendar Widget
          </Link>
        </li>
        {/* Ticker Widget */}
        <li>
          <Link href="/market/ticker" className={`block px-8 py-4 text-sm ${styles.custom}`}>
            Ticker Widget
          </Link>
        </li>
        {/* Symbol Overview Widget */}
        <li>
          <Link href="/market/symbol-overview" className={`block px-8 py-4 text-sm ${styles.custom}`}>
            Symbol Overview Widget
          </Link>
        </li>
        {/* Forex Cross Rates Widget */}
        <li>
          <Link href="/market/forex-cross-rates" className={`block px-8 py-4 text-sm ${styles.custom}`}>
            Forex Cross Rates Widget
          </Link>
        </li>
      </ul>
